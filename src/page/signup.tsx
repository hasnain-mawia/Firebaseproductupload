  ...
  return (
    <div className='max-w-[1300px] mx-auto my-10'>
        ...
        <div className='bg-[#387EF5] py-10 rounded-[30px] flex flex-col gap-5 justify-center items-center text-white px-10 text-center'>
            ...
            <CInputField onChange={(e:any)=> setvalues({...values,password:e.target.value})} value={values.password} id='password' name='password' className=' bg-[#ffffff] p-2 rounded-md w-full' type="password"/>
            {errors.password && <span className='text-[14px] text-[red]'>{errors.password}</span>}
            <label>Confirm Password</label>
            <CInputField onChange={(e:any)=> setvalues({...values,cpassword:e.target.value})} value={values.cpassword} id='cpassword' name='cpassword' className=' bg-[#ffffff] p-2 rounded-md w-full' type="password"/>
